...
public class Test3 {
    ...
    private static final String TEST_TEXT = "// Test 3 : cifre :  1234567890"; // TODO: change that

    // the file you want to compress
    private static final String DECOMPRESSED_PATH = "./tests/text3.txt"; // TODO: change that

    // the destination file for the compressed text
    private static final String COMPRESSED_PATH = "./tests/compressed3.txt"; // TODO: change that

    // the result file with the decompressed text
    private static final String RESULT_PATH = "./tests/rez3.txt"; // TODO: change that
